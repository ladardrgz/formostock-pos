document.addEventListener('DOMContentLoaded', () => {
    ...
    backButton.src = '/FormoStock/app/assets/img/flechaIzquierda.png'; // Asegúrate de que la ruta sea correcta
    ...
    forwardButton.src = '/FormoStock/app/assets/img/flechaDerecha.png'; // Asegúrate de que la ruta sea correcta
