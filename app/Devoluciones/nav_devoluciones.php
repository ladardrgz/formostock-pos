<nav class="navbar navbar-expand-lg">
    <div class="container-fluid">
        <a class="navbar-brand" href="/FormoStock/app/Devoluciones/dashboardDevoluciones.php">Devoluciones</a>
        ...
        <div class="collapse navbar-collapse" id="navbarScroll">
            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                <!-- Página principal -->
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="/FormoStock/app/Devoluciones/dashboardDevoluciones.php">Página principal</a>
                </li>
            </ul>
